...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		/*
			//, 'lang' TEXT DEFAULT '', 'icon' TEXT DEFAULT '','pub_date' TEXT DEFAULT '', 'params' TEXT DEFAULT '');
				if _, err := db.AddColumn("feed", "icon", `TEXT`).Execute(); err != nil {
					return err
				}
				if _, err := db.AddColumn("feed", "lang", `TEXT`).Execute(); err != nil {
					return err
				}
				if _, err := db.AddColumn("feed", "pub_date", `TEXT`).Execute(); err != nil {
					return err
				}
		*/
